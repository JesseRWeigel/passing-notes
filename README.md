...
results/                   what the measurement scripts wrote, regenerated by verify
```
...
== repo hygiene
  ...
  ok    no credential-shaped strings and no absolute home paths in tracked files
       scanned 34 tracked files for 8 patterns
...
== two real browsers
  ok    28 browser checks passed
         ...
         ok    the handshake blobs are 632 and 631 characters, against a 34 character game
